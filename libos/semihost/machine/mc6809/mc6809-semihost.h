 ...
 *   0xBF00  ACIA status (bit 1 = TDRE, bit 0 = RDRF)
 *   0xBF01  ACIA data (read/write)
 *   0xBF02  Halt device (written value = exit code)
 */
...
#define MC6809_ACIA_STATUS  (*(volatile uint8_t *)0xBF00)
#define MC6809_ACIA_DATA    (*(volatile uint8_t *)0xBF01)
#define MC6809_HALT         (*(volatile uint8_t *)0xBF02)
